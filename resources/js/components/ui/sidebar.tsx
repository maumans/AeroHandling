...
function Sidebar({
  ...
  return (
    ...
    >
      ...
      <div
        className={cn(
          "relative shrink-0 h-svh w-[var(--sidebar-width)] bg-transparent transition-[width] duration-200 ease-linear",
...
function SidebarInset({ className, ...props }: React.ComponentProps<"main">) {
  return (
    <main
      ...
      className={cn(
        "bg-background relative flex min-w-0 min-h-svh flex-1 flex-col overflow-hidden",
