...
export default function AdministrationTypesEquipementEditer({ type }: Props) {
    ...
    function soumettre(e: React.FormEvent) {
        e.preventDefault();
        put(`/administration/types-equipement/${type.id}`);
    }

    function supprimer() {
        if (confirm(t("Voulez-vous vraiment supprimer ce type d'équipement ?"))) {
            destroy(`/administration/types-equipement/${type.id}`);
        }
    }
    ...
    return (
        <AppLayout breadcrumbs={[
            ...
            { title: type.code, href: `/administration/types-equipement/${type.id}/edit` },
        ]}>
            ...
            <div className="flex flex-col gap-6 p-4 md:p-6">
                <div className="flex items-center gap-3">
                    ...
                    <h1 className="text-2xl font-bold">{t("Modifier le type d'équipement")}</h1>
                </div>
