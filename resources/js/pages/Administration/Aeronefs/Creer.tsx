...
export default function AdministrationAeronefsCreer({ categories }: Props) {
    ...
    return (
        <AppLayout breadcrumbs={[
            ...
            { title: 'Nouvel aéronef', href: '/administration/aeronefs/creer' },
        ]}>
            <Head title="Nouvel aéronef" />
            <div className="flex flex-col gap-6 p-4 md:p-6">
                <div className="flex items-center gap-3">
                    <Button variant="ghost" size="icon" asChild>
                        <Link href="/administration/aeronefs"><ArrowLeft className="size-4" /></Link>
                    </Button>
                    <h1 className="text-2xl font-bold">Nouvel aéronef</h1>
                </div>

                <Card className="max-w-xl">
                    <CardHeader><CardTitle>Informations de l&apos;aéronef</CardTitle></CardHeader>
                    <CardContent>
                        <form onSubmit={soumettre} className="flex flex-col gap-4">
                            ...
                            <div className="flex justify-end gap-2 pt-2">
                                ...
                                <Button type="submit" disabled={processing}>
                                    {processing ? 'Création...' : 'Créer l\'aéronef'}
                                </Button>
                            </div>
                        </form>
                    </CardContent>
