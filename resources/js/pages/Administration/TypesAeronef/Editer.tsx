...
export default function AdministrationTypesAeronefEditer({ type }: Props) {
    ...
    function soumettre(e: React.FormEvent) {
        e.preventDefault();
        put(`/administration/types-aeronef/${type.id}`);
    }

    function supprimer() {
        if (confirm(t("Voulez-vous vraiment supprimer ce type d'aéronef ?"))) {
            destroy(`/administration/types-aeronef/${type.id}`);
        }
    }
    ...
    return (
        <AppLayout breadcrumbs={[
            ...
            { title: type.code, href: `/administration/types-aeronef/${type.id}/edit` },
        ]}>
            ...
            <div className="flex flex-col gap-6 p-4 md:p-6">
                <div className="flex items-center gap-3">
                    ...
                    <h1 className="text-2xl font-bold">{t("Modifier le type d'aéronef")}</h1>
                </div>
